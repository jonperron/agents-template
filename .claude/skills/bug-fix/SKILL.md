---
name: bug-fix
description: Use when implementing a bug fix.
---

# Bug fix

When a bug fix is asked by the user, implement it using a test driven development (TDD) approach.
...
For QA, run the agents related to review the security, tests and code before marking a task as done.
