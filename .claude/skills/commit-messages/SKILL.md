...
description: Use when writing a git commit message, a PR title, or a PR body. Covers conventional commit format, the scopes in use, body structure, and what must be called out.
---
